    ...
    <div className="flex flex-col items-center justify-center min-h-screen px-8">
      ...
      <main className="max-w-xl text-lg leading-relaxed">
        ...
        <p className="mt-4">
          ...
          I&apos;m currently transitioning from technical writing to software
          development.
        </p>
        {/* 
        ...
        <p className="mt-4">
          I&apos;m passionate about collaborating and exploring creative
